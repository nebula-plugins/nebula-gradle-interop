...
data class VersionWithSelector(val stringVersion: String, val gradle: Gradle? = null, val version: Version = VERSION_PARSER.transform(stringVersion)) : Comparable<Version>, Version by version {
